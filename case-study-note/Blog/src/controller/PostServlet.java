...
//add
    private void createComment(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (idUser != -1) {
            ...
            Post post = this.postImpl.getPostById(id);
    ...
    private void deletePost(HttpServletRequest request, HttpServletResponse response) {
        int id = Integer.parseInt(request.getParameter("id"));
        Post deletePost = this.postImpl.getPostById(id);
        this.postImpl.deletePost(deletePost);
        try {
    ...
    private void updatePost(HttpServletRequest request, HttpServletResponse response) {
        ...
        this.postImpl.updatePost(id, post);
        request.setAttribute("posts", post);
...
/*        int user = Integer.parseInt(request.getParameter("user"));*/
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) {
        int id = Integer.parseInt(request.getParameter("id"));
        Post existingPost = this.postImpl.getPostById(id);
    ...
    private void listPosts(HttpServletRequest request, HttpServletResponse response) {
        List<Post> posts = this.postImpl.getAllPosts();
